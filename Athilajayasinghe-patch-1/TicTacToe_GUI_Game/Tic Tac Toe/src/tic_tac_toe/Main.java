...
//this is the start page and first creat the pannel and buttons.
    JPanel startPage;
    ...
    JButton gamePage_reset;
// add the colurs and font
...
// add the fonts to various buttons
        ...
        gamePage_reset.setFont(font);

    }

    private void setThemeColors(Color textColor, Color backgroundColor) {
//add the theam colours to pages and buttons.
        ...
        gamePage_reset.setBackground(backgroundColor);
        gamePage_reset.setForeground(textColor);
...
//in here create single player page
...
//create multi player page and insert the buttons
...
//create setting page and insert the buttons
...
//create the game page and add the buttons
        ...
        gamePage_reset = new JButton("Reset");
...
//add the 9 buttons to print x and o
...
//add the buttons and sizes of the buttons to the game page
        ...
        gamePage.add(gamePage_reset);
//demenstions of the buttons
        ...
        gamePage_reset.setBounds(120, 430, 140, 30);
...
//this is the rules for selecting for winner
...
//this is the end of the game and result of the game
...
//this is the single player game end and the final results
...
//this is the print of the player name who is the next to play
...
//this is method of start a new game
...
//this is the board of the game
        ...
        add(settingsPage);
        add(gamePage);
//this is the layout in the board
        ...
        startPage_about.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                String aboutGame
                        ...
                        + "<p>Prepared by a <b>Athila Jayasinghe</b><br><br>"
                        + "If you have any comments, please let me know<br><br>"
                        + "email: &nbsp athilajayasinghee@gmail.com<br>"
                        + "twitter & facebook: &nbsp Athila Jayasinghe<br><br>"
                        + "<u>Note</u><br>"
                        + "I used JDK 1.8 to compile the source code.<br><br<br>"
                        + "<p><i>© CopyRight 2024 Athila_Jayasinghe - All Rights Reserved</i</p>"
                        + "<html>";
        ...
        gamePage_reset.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
